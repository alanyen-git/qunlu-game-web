...
render("blacksmith");
assert(sandbox.lastHtml.includes("openCrafting('blacksmith','全部')"),"other professions must retain All");
assert.deepEqual(rows(),["鐵劍"]);
console.log("alchemy effective renderer regression OK: late override, 90 recipes -> five single-purpose tabs, no All, normal blacksmith");
