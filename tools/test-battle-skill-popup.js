...
assert.equal(ver.version,"CURRENT-2.12.3");assert.equal(ver.pwa_cache_revision,"v134");
assert.match(html,/src\/runtime\.js\?v=CURRENT-2\.12\.3-BATTLE-SKILL2/);
assert.match(sw,/CACHE_PREFIX\+"v134"/);
