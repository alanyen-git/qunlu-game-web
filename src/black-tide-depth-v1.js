/* 群陸旅誌：黑潮群島完整區域深化 CURRENT-1.96.0
 * BLACK-TIDE-DEPTH-1.0
...
const REV="BLACK-TIDE-DEPTH-1.0";
...
const ISLANDS=[
 {id:"BT-ISL-01",name:"玄潮島",class:"major",tier:"C",province:"PROV-BT-01",smap:"SMAP-BT-01",seat:"L-BT-KYO",role:"王庭與幕府共同核心",economy:["行政","工藝","高階港務","文書"],risk:["人口集中","派閥競爭","颱風季港務壓力"]},
...
const TOWNS=[
 {id:"L-BT-KYO",name:"黑潮京",tier:"C",size:"大城",islandId:"BT-ISL-01",island:"玄潮島",province:"PROV-BT-01",smap:"SMAP-BT-01",
  role:"潮皇王庭所在地／群島法統與文化中心",description:"玄潮島北灣的大城。王庭、典儀院、書庫、商町與工坊沿內河展開；潮皇在此主持祭祀、冊命與群島共同禮制。",
  facilities:["guild","general","blacksmith","tailor","alchemy","tavern","inn","church","clinic"],safety:95,
  authority:{office_title:"王庭京尹",reports_to:"潮皇王庭",authority_tier:"AUTH-5",jurisdiction:"黑潮京城務、治安與王庭外圍行政"},
 ...
 {id:"L-BT-SHOGUNPORT",name:"黑潮灣",tier:"C",size:"大港",islandId:"BT-ISL-01",island:"玄潮島",province:"PROV-BT-01",smap:"SMAP-BT-01",
  role:"幕府評定所與聯合艦隊主港",description:"玄潮島南側深水港。幕府評定所、海防奉行所、軍船泊地、海關與大型倉庫集中於此，是群島實際軍政與海運中樞。",
  facilities:["guild","general","blacksmith","tailor","alchemy","tavern","inn","church","clinic"],safety:93,
  authority:{office_title:"黑潮灣奉行",reports_to:"征海大將軍／幕府評定所",authority_tier:"AUTH-5",jurisdiction:"軍港、海關、倉儲與外來船舶"},
 ...
 {id:"L-BT-AKAMINATO",name:"赤浦港",tier:"D",size:"港城",islandId:"BT-ISL-02",island:"赤浦島",province:"PROV-BT-02",smap:"SMAP-BT-02",
  role:"赤浦大名居城港／造船基地",description:"赤浦島西灣的港城，船渠、木場與鐵件工坊沿岸排列。赤浦家負責西南海防並向幕府提供軍船。",
  facilities:["guild","general","blacksmith","tailor","tavern","inn","church","clinic"],safety:91,
  authority:{office_title:"赤浦島奉行",reports_to:"赤浦大名／幕府",authority_tier:"AUTH-4",jurisdiction:"造船、海防、島內稅務"},
 ...
 {id:"L-BT-AOMISAKI",name:"青岬城",tier:"D",size:"城下町",islandId:"BT-ISL-03",island:"青岬島",province:"PROV-BT-03",smap:"SMAP-BT-03",
  ...
  authority:{office_title:"青岬城代",reports_to:"青岬大名／幕府",authority_tier:"AUTH-4",jurisdiction:"糧政、水利、林地與道路"},
 ...
 {id:"L-BT-SHIRASUNA",name:"白砂港",tier:"E",size:"小港町",islandId:"BT-ISL-04",island:"白砂島",province:"PROV-BT-04",smap:"SMAP-BT-04",
  ...
  authority:{office_title:"白砂島代官",reports_to:"幕府海防奉行",authority_tier:"AUTH-3",jurisdiction:"鹽課、漁場與蓄水"},
 ...
 {id:"L-BT-SHIOMI",name:"潮見町",tier:"E",size:"漁港町",islandId:"BT-ISL-05",island:"潮見島",province:"PROV-BT-05",smap:"SMAP-BT-05",
  ...
  authority:{office_title:"潮見港代",reports_to:"幕府港務奉行",authority_tier:"AUTH-3",jurisdiction:"水先、渡船、碼頭與礁航標"},
 ...
 {id:"L-BT-HAITOU",name:"灰燈港",tier:"E",size:"前哨港",islandId:"BT-ISL-06",island:"灰燈島",province:"PROV-BT-06",smap:"SMAP-BT-06",
  ...
  authority:{office_title:"灰燈海防代",reports_to:"幕府海防奉行",authority_tier:"AUTH-4",jurisdiction:"外海警戒、護航與烽燈"},
 ...
 {id:"L-BT-KUJIRA",name:"鯨背村",tier:"E",size:"港村",islandId:"BT-ISL-07",island:"鯨背島",province:"PROV-BT-07",smap:"SMAP-BT-07",
  ...
  authority:{office_title:"鯨背島代官",reports_to:"幕府海防奉行",authority_tier:"AUTH-3",jurisdiction:"採石、漁場與南航補給"},
 ...
 {id:"L-BT-KIRIURA",name:"霧浦町",tier:"E",size:"小港町",islandId:"BT-ISL-08",island:"霧浦島",province:"PROV-BT-08",smap:"SMAP-BT-08",
  ...
  authority:{office_title:"霧浦島代官",reports_to:"幕府港務奉行",authority_tier:"AUTH-3",jurisdiction:"水源、林地、藥草與避風泊位"},
...
const DUNGEONS=[
 {id:"D-BT-SEAGATE",name:"舊海門地道",islandId:"BT-ISL-01",island:"玄潮島",province:"PROV-BT-01",smap:"SMAP-BT-01",tier:"C",kind:"dungeon",size:"城防地下通道",tags:["dungeon","ruins","water"],zone:"dungeon",archetype:"fortress_basement",space:"standard",aquatic:true,allowUndead:true,safety:42,risk:34,
  description:"舊城防海門下方的封閉地道，部分區段與潮水相通。幕府只開放已測繪外層，深處仍有舊守衛構裝與不穩定水道。",
...
const NPCS=[
 {id:"NPC-BT-001",name:"汐宮 景仁",role:"潮皇",tier:"C",location_id:"L-BT-KYO",knowledge_scope:"王庭禮制、冊命、群島正史與外交禮儀",combat_tier_ceiling:"D",organization_ids:["ORG-BT-COURT"],services:["王庭接見","高階冊命劇情"],description:"現任潮皇。維持王庭法統與諸島共同儀禮，不直接處理日常軍政。"},
 {id:"NPC-BT-002",name:"鷹森 宗政",role:"征海大將軍",tier:"B",location_id:"L-BT-SHOGUNPORT",knowledge_scope:"幕府軍政、海防、諸島大名與對外戰略",combat_tier_ceiling:"B",organization_ids:["ORG-BT-BAKUFU"],services:["幕府軍政劇情","高階海防委託"],description:"現任征海大將軍，主持幕府評定與聯合海防。"},
 {id:"NPC-BT-003",name:"早瀨 信綱",role:"幕府老中首座",tier:"C",location_id:"L-BT-SHOGUNPORT",knowledge_scope:"評定所、諸島人事、稅務與政令執行",combat_tier_ceiling:"D",organization_ids:["ORG-BT-BAKUFU"],services:["幕府文書","大名協調"],description:"負責把將軍裁示轉成各奉行與島領能執行的政令。"},
 ...
 {id:"NPC-BT-006",name:"赤津 盛房",role:"赤浦大名",tier:"C",location_id:"L-BT-AKAMINATO",knowledge_scope:"赤浦造船、島領武家、西南海防",combat_tier_ceiling:"C",organization_ids:["ORG-BT-BAKUFU"],services:["造船軍需委託","島領引介"],description:"赤浦島領主，維持船渠與軍船供應，以實務能力在幕府中有發言權。"},
 ...
 {id:"NPC-BT-014",name:"堀江 泰成",role:"冒險者公會黑潮支部長",tier:"C",location_id:"L-BT-SHOGUNPORT",knowledge_scope:"群島委託、地下城、怪物分布與冒險者資格",combat_tier_ceiling:"C",organization_ids:[],services:["冒險者委託","群島收購櫃檯"],description:"協調八島公會櫃檯與幕府海防需求，不讓低階冒險者被派去超階地圖。"},
 ...
 {id:"NPC-BT-016",name:"島田 宗介",role:"幕府裁判奉行",tier:"C",location_id:"L-BT-KYO",knowledge_scope:"武家法、港灣法、船誓與跨島爭議",combat_tier_ceiling:"D",organization_ids:["ORG-BT-BAKUFU"],services:["法律查詢","跨島仲裁"],description:"處理武家、商船與島民之間的跨島案件，重證據、航海紀錄與正式印記。"}
];
for(const n of NPCS)upsert("regional_npc_archetypes",{...n,region_id:REGION_ID,polity_id:POLITY_ID});

const DIALOGUES=[
 ["DIA-BT-001","NPC-BT-001","王庭","幕府治理海疆，王庭維繫的是讓諸島仍承認彼此同屬一國的法統。"],
 ...
 ["DIA-BT-005","NPC-BT-005","冊命","冊封不是替幕府任命官員；它確認的是島領身分與王庭承認的禮序。"],
...
const ORGS=[
 {id:"ORG-BT-COURT",name:"潮皇王庭",kind:"court",tier:"C",region_id:REGION_ID,base_location_id:"L-BT-KYO",description:"維持祭祀、冊命、法統、典禮與王庭文書的國家禮制核心。"},
 {id:"ORG-BT-BAKUFU",name:"幕府評定所",kind:"government",tier:"C",region_id:REGION_ID,base_location_id:"L-BT-SHOGUNPORT",description:"征海大將軍統領的實際軍政中樞，統合海防、稅務、裁判與諸島治理。"},
...
const profile={
 ...
 identity:"三大島、五小島與外圍礁島共同構成的海島國。王庭維繫法統與祭儀，幕府掌軍政與海防，各島以大名、奉行、港代與代官落實治理。",
...
const HOOKS=[
 ...
 {id:"HOOK-BT-06",title:"舊海門封條",premise:"黑潮京舊海門地道的封條受潮破裂，王庭與幕府要求共同見證後才能深入。",tier:"C"}
];
...
const LIFE=[
 ...
 {id:"LIFE-BT-03",name:"王庭冊命日",text:"王庭典禮確認島領禮序與官位，但不等同幕府對實際軍政職務的任命。"},
 {id:"LIFE-BT-04",name:"巡燈夜",text:"外海島民在風暴季前共同檢查燈塔、烽臺與備用燈油。"},
 {id:"LIFE-BT-05",name:"鹽田輪水",text:"白砂島旱季優先保障飲水，鹽田引水會被限量，鹽價因此出現季節波動。"},
 {id:"LIFE-BT-06",name:"島際公船",text:"幕府與地方港代維持基本公船班次，低繁榮小島仍可能因風浪中斷數日。"}
];
...
if(realm){
 ...
 realm.notes="三大島、五小島與七個外圍小型島礁構成同一獨立群島國；王庭與幕府為平行頂層權力，各島透過大名、奉行、港代與代官治理。";
}
...
if(polity){
 ...
 polity.military_structure=["幕府直轄聯合艦隊","諸島大名水軍","海防奉行巡船","港代與烽燈網"];
 polity.current_tensions=["王庭禮序與幕府實務協調","大島軍費與小島民生分配","金衡自由港的轉口競爭","風暴季護航與糧運"];
 polity.gameplay_role="完整海島幕府國／島際航行、武門政治、漁鹽造船、海防與群島探索";
}
...
if(authority){
 ...
 const extra=[
  {id:"POL-010-O5",title:"幕府老中首座",authority_tier:"AUTH-6",authority_level:6,scope:"評定所政務統籌與大名協調",appointment:"征海大將軍任命",rights:["AR-003","AR-004","AR-005","AR-008"],reports_to:"POL-010-O2",notes:"將軍之下的最高常務政務協調者。"},
  {id:"POL-010-O6",title:"海防奉行",authority_tier:"AUTH-5",authority_level:5,scope:"艦隊、巡航、燈塔、護航與軍港",appointment:"幕府任命",rights:["AR-003","AR-004","AR-008"],reports_to:"POL-010-O5",notes:"統籌群島海防，不具有獨立外交權。"},
  {id:"POL-010-O7",title:"財賦奉行",authority_tier:"AUTH-5",authority_level:5,scope:"島際稅賦、倉儲、鹽課與軍費",appointment:"幕府任命",rights:["AR-003","AR-005","AR-008"],reports_to:"POL-010-O5",notes:"協調各島稅務與幕府直轄收入。"},
  {id:"POL-010-O8",title:"裁判奉行",authority_tier:"AUTH-5",authority_level:5,scope:"武家法、港灣法與跨島案件",appointment:"幕府任命",rights:["AR-003","AR-005","AR-008"],reports_to:"POL-010-O5",notes:"跨島重大司法節點。"},
  {id:"POL-010-O9",title:"島代官",authority_tier:"AUTH-3",authority_level:3,scope:"小島行政、徵收、治安與公共工程",appointment:"幕府或大名任命",rights:["AR-003","AR-005"],reports_to:"POL-010-O4",notes:"五小島主要地方行政職。"},
 ...
 authority.rival_power_centers=["潮皇王庭","幕府評定所","赤浦與青岬等主要島領","大型船匠與港商","水先人會"];
 authority.player_interaction_summary="低階玩家多接觸港代、島代官、公會與地方奉行；中階可進入大名與奉行層；幕府評定與王庭冊命保留給高階劇情。";
}

const LORE=[
 {id:"LORE-BT-01",category:"geography",title:"三大島與五小島",text:"玄潮、赤浦、青岬為三大島；白砂、潮見、灰燈、鯨背、霧浦為五小島。外圍七個小型島礁主要服務航標、漁汛與臨時避風，不另設完整島領政府。"},
 {id:"LORE-BT-02",category:"politics",title:"王庭與幕府的分工",text:"潮皇王庭維繫祭祀、冊命、法統與共同禮制；征海大將軍與幕府掌軍政、海防、稅務與諸島治理。兩者同屬黑潮群島國家體制，不是兩個國家。"},
 {id:"LORE-BT-03",category:"military",title:"群島海防網",text:"海防由幕府直轄聯合艦隊、主要大名水軍、海防奉行巡船與外島烽燈共同構成；控制航道與補給港比守住連續陸地邊界更重要。"},
 {id:"LORE-BT-04",category:"economy",title:"島際分工",text:"玄潮島提供行政與高階市場，赤浦島偏造船軍需，青岬島供糧與竹木，小島分別承擔鹽、漁、水先、護航、石材與藥草等功能。"},
 {id:"LORE-BT-05",category:"society",title:"港町與武家的日常",text:"多數島民首先面對的是港代、島代官、行會、公會與地方武家；高階王庭或幕府政治不會因玩家抵達就直接介入日常。"},
...
DB.black_tide_archipelago={
 ...
 governance:{
  sovereign_legal_center:"潮皇王庭",executive_military_center:"征海大將軍／幕府評定所",
  major_island_rule:"主要島由大名與幕府奉行共同構成地方權力網；大名領地世襲需幕府安堵並受王庭名義冊封。",
  minor_island_rule:"五小島以島代官、港代與地方武家治理，軍政最終受幕府奉行體系節制。"
 },
