...
const FIELDS=[
 ...
 {id:"L-SUN-SILVERWOOD",name:"銀橡林",zoneId:"SUN-Z-04",province:"PROV-SUN-04",smap:"SMAP-SUN-04",tier:"D",size:"混合林",tags:["forest"],template:"L-WOOD",risk:26,woodcut:["SUN-MAT-005"],gather:["SUN-MAT-016"],hunt:["SUN-MAT-007"],preferred:["MON-SUN-006","MON-SUN-015","MON-SUN-019"],description:"銀灰樹皮的硬木林，樹脂與硬木是重要商品；林務官按年度區塊輪伐。"},
 ...
 {id:"L-SUN-REDCLIFF",name:"赤崖牧場",zoneId:"SUN-Z-06",province:"PROV-SUN-06",smap:"SMAP-SUN-06",tier:"D",size:"紅岩牧坡",tags:["hill"],template:"L-HILL",risk:24,mining:["SUN-MAT-010"],hunt:["SUN-MAT-006"],preferred:["MON-SUN-012","MON-SUN-013"],description:"紅色岩層與草坡交錯的公用牧場，燧石可少量採集，但大型採石需地方許可。"},
 ...
 {id:"L-SUN-PRINCEWOOD",name:"諸侯松林",zoneId:"SUN-Z-08",province:"PROV-SUN-08",smap:"SMAP-SUN-08",tier:"C",size:"封邑林地",tags:["forest","hill"],template:"L-WOOD",risk:32,woodcut:["SUN-MAT-005"],hunt:["SUN-MAT-007"],preferred:["MON-SUN-015","MON-SUN-019","MON-SUN-021"],description:"多個封邑交界的高大松橡林，獵權、伐木權與道路權常需要以誓約文書核對。"},
