(()=>{
  ...
  window.addEventListener("load",()=>{
    ...
    navigator.serviceWorker.register("sw.js?v=CURRENT-2.05.0",{scope:"./"})
      .then(registration=>registration.update().catch(()=>null))
      .catch(error=>console.warn("Service worker registration failed",error));
  },{once:true});
  globalThis.QUNLU_CORE?.registerModule?.("src/pwa.js",{domain:"finalization",revision:"PWA-BOOT-1.6",release:globalThis.QUNLU_RELEASE_VERSION});
})();
