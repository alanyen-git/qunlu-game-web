...
const AREAS=[
 ...
 {id:"L-IP-ANVILRIDGE",name:"砧風坡",cluster_id:"L-START-IRONPINE",polity_id:"POL-013",region_id:"REG-13",culture_id:"CUL-013",region:"安威爾山地",history_scope:"安威爾帝國／西北山廳外緣",template:"L-HILL",size:"山坡",description:"鐵松村外的低矮礦脈坡地，能採到基礎礦材，但較高山區仍被巡山隊封鎖。",links:[{to:"L-START-IRONPINE",hours:1.2},{to:"L-IP-BLACKVEIN",hours:1.2},{to:"D-IP-OLDMINE",hours:1.4}],encounter_tags:["mountain","plains"],nearest_town_distance_hours:1.2,safety_score:79,explore:[["裸露礦脈",30],["松木坡",25],["礦車舊轍",20],["碎石棚",15],["山羊足跡",10]],resource_profile:{forage:["I-BRANCH","I-HERB"],mining:["I-ORE-BRONZE","I-ORE-IRON","MAT-ORE-02","MAT-ORE-09","MAT-ORE-10"],woodcut:[],hunt:["I-RAWMEAT"],fish:[]}},
