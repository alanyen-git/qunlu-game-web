...
const FIELDS=[
 ...
 {id:"L-WF-SALTMEADOW",name:"鹽草低地",zoneId:"WF-Z-04",province:"PROV-WF-04",smap:"SMAP-WF-04",tier:"D",size:"鹽化草甸",tags:["plains","wetland"],template:"L-LOWFIELD",risk:25,gather:["WF-MAT-003"],hunt:["WF-MAT-008"],preferred:["MON-WF-011","MON-WF-016","MON-WF-020"],explore:[["鹽花泥地",25],["野牛足痕",20],["牧鹽草叢",20],["乾季裂紋",20],["舊取鹽坑",15]],description:"河漫低地蒸發留下鹽花，既是野生草獸補鹽地，也是受配額管理的小型河鹽來源。"},
...
const DUNGEONS=[
 {id:"D-WF-KHANMOUND",name:"古汗丘陵墓",zoneId:"WF-Z-01",province:"PROV-WF-01",smap:"SMAP-WF-01",tier:"C",size:"古代丘陵墓",tags:["dungeon","ruins"],archetype:"tomb",allowMagical:true,risk:35,gather:[],preferred:["MON-WF-022","MON-WF-013"],explore:[["石馬門",25],["封土甬道",20],["車輪紋壁",20],["陪葬庫",20],["石衛室",15]],description:"早期汗王的封土丘陵墓，受汗庭史官與誓儀所共同保護；開放區與封存區嚴格分離。"},
 {id:"D-WF-SKYVAULT",name:"天風石庫",zoneId:"WF-Z-01",province:"PROV-WF-01",smap:"SMAP-WF-01",tier:"D",size:"舊汗庭石庫",tags:["dungeon","ruins","cave"],archetype:"artificial_ruin",risk:27,gather:[],preferred:["MON-WF-010","MON-WF-017"],explore:[["石庫坡道",25],["舊車帳槽",20],["乾糧室",20],["通風井",20],["封門銅片",15]],description:"固定岩層下的舊式公共物資庫，後因路線變動停用，現作為中低階勘查遺構。"},
 {id:"D-WF-NORTHBARROW",name:"北路石塚",zoneId:"WF-Z-02",province:"PROV-WF-02",smap:"SMAP-WF-02",tier:"D",size:"北境石塚群",tags:["dungeon","ruins"],archetype:"tomb",risk:29,gather:[],preferred:["MON-WF-010","MON-WF-018"],explore:[["風蝕石塚",25],["舊驛火室",20],["封石縫",20],["獸穴側道",20],["北路刻記",15]],description:"歷代北路護送者與巡騎留下的石塚群，部分空洞被野獸利用，並非所有墓室都對冒險者開放。"},
 ...
 {id:"D-WF-RIVERFORT",name:"雁河舊渡堡",zoneId:"WF-Z-04",province:"PROV-WF-04",smap:"SMAP-WF-04",tier:"D",size:"廢棄渡堡",tags:["dungeon","ruins","water"],archetype:"fort_ruin",aquatic:true,risk:30,gather:[],preferred:["MON-WF-015","MON-WF-020"],explore:[["斷橋門",25],["水淹庫房",20],["渡稅石",20],["半塌箭樓",20],["河底暗門",15]],description:"舊時固定渡口留下的低矮石堡，河道改向後廢棄，春汛會淹沒底層。"},
...
for(const [itemId,source] of [["WF-MAT-002","白氈羊群季節剪毛"],["WF-MAT-009","馬政署與牧群梳理"],["WF-MAT-014","汗庭史錄官／誓儀所授權遺構回收"]]){const s=DB.content_link_index.item_sources[itemId];if(s&&!s.special_sources.includes(source))s.special_sources.push(source)}
