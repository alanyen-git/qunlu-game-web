...
function installGoldHengDepth(){
 ...
 for(const z of p.provinces){const ids=[...z.subordinate_settlement_ids,...z.wild_location_ids,...z.dungeon_location_ids];polyUpsert("settlement_region_maps",{id:"SMAP-"+z.id,name:z.name+"區域",parent_province_region_id:z.id,center_location_id:z.capital_location_id,world_tier:z.world_tier,map_status:"playable_current",location_ids:ids,role:z.identity,orientation:z.orientation})}
